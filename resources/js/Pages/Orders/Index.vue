        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white p-12 rounded-3xl border border-secondary shadow-sm text-center">
                    ...
                    <h3 class="text-2xl font-bold text-foreground mb-2">Orders Page Coming Soon</h3>
                    <p class="text-muted-foreground">We are working on the order management system. Please check back later.</p>
                </div>
            </div>
        </div>
    </AppLayout>
